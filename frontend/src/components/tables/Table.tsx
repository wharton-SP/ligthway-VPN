              ...
              <tbody>
                {data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="group-hover:bg-gray-100 px-2 py-1">
                      <div>
                        Sent: {((item?.metrics?.traffic?.received_mb ?? 0) / 8).toFixed(2)} Mo
                      </div>
                      <div>
                        Received: {((item?.metrics?.traffic?.sent_mb ?? 0) / 8).toFixed(2)} Mo
                      </div>
                      <div>
                        Total: {((item?.metrics?.traffic?.total_mb ?? 0) / 8).toFixed(2)} Mo
                      </div>
                    </td>
                    <td className="group-hover:bg-gray-100 px-2 py-1">
                      <div>
                        Sent: {(((item?.bandwidth?.recv_mbps ?? 0) / 8)).toFixed(2)} Mo/s
                      </div>
                      <div>
                        Received: {((item?.bandwidth?.sent_mbps ?? 0) / 8).toFixed(2)} Mo/s
                      </div>
                    </td>
